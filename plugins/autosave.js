...
cmd(
  ...
  async (malvin, mek, m, { reply }) => {
    try {
      ...
      const displayName = senderName ? `${senderName} ᴍᴇᴢᴜᴋᴀ ᴍᴅ 🩵` : "ᴍᴇᴢᴜᴋᴀ ᴍᴅ 🩵";
      ...
      await malvin.sendMessage(
        from,
        {
          image: { url: "https://raw.githubusercontent.com/Nimeshkamihiran/Helper-image-mezuka/main/a0a4277b37e65ad52e4811c7bee8c46d.jpg" },
